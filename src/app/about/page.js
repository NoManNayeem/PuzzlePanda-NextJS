  ...
  return (
    <div className="font-[sans-serif] text-[#333] p-4">
      <div className="max-w-3xl max-md:max-w-md mx-auto">
        <h2 className="text-4xl font-extrabold text-center">The Team</h2>
        <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-12 max-sm:justify-center text-center mt-12">
          <div className="bg-gray-200 max-w-[230px] rounded-tl-full rounded-tr-full rounded-md">
            ...
            <div className="p-4">
              ...
              <p className="text-xs font-semibold mt-1">Software Engineer</p>
              <p className="mt-2">
          ...
          <div className="bg-gray-200 max-w-[230px] rounded-tl-full rounded-tr-full rounded-md">
            ...
            <div className="p-4">
              ...
              <p className="text-xs font-semibold mt-1">Web Designer</p>
              <p className="mt-2">
                Eiusmod commodo aliquip laboris qui anim non voluptate
                consectetur.
              </p>

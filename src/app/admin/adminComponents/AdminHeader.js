...
const AdminHeader = () => {
    ...
    const userData = {
        ...
        phone: "+1234567890",
        birthday: "Jan 1, 1990",
        imageUrl: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // Placeholder image
        ...
        <>
            ...
            {isSidebarOpen && (
                <div className="fixed inset-0 z-50 flex">
                    <div className="bg-black opacity-50 flex-grow" onClick={() => setSidebarOpen(false)}></div>
                        ...
                        <div className="flex-grow">
                            <div className="text-center mt-4">
                                ...
                                <div className="mt-4 text-left">
                                    <p className="flex items-center"><FaPhone className="mr-2"/> {userData.phone}</p>
                                    <p className="flex items-center"><FaEnvelope className="mr-2"/> {userData.email}</p>
                                    <p className="flex items-center"><FaBirthdayCake className="mr-2"/> {userData.birthday}</p>
                                </div>
                                <div className="mt-4 p-3 bg-gradient-to-br from-green-400 to-blue-400 rounded-lg shadow">
                                    ...
                                    <p className="text-white">Completed: {userData.puzzlesCompleted}</p>
                                    <p className="text-white">In Progress: {userData.puzzlesInProgress}</p>
                                </div>
                            </div>
                        </div>
                        {/* Logout button */}
                        <button onClick={handleLogout} className="mt-4 p-2 bg-red-600 text-white flex justify-center items-center rounded hover:bg-red-700 transition duration-300 w-full">
